...
export default function ReviewModal(props: ReviewModalProps) {
  ...
  useEffect(() => {
    axios
      .get(
        `http://ec2-3-35-26-239.ap-northeast-2.compute.amazonaws.com:8081/projects/${projectName}`,
      )
      .then((res) => {
  ...
  const onSubmit: SubmitHandler<any> = (data: any) => {
    ...
    axios
      .post(
        'http://ec2-3-35-26-239.ap-northeast-2.compute.amazonaws.com:8081/reviews',
      ...
      .then(() => {
        ...
        axios.patch(
          `http://ec2-3-35-26-239.ap-northeast-2.compute.amazonaws.com:8081/projects/${projectName}/status/review-completed`,
        );
      })
      .catch(() => {});
  };
