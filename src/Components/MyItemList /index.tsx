...
export default function MyItemList() {
  ...
  useEffect(() => {
    axios
      .get('http://ec2-3-35-26-239.ap-northeast-2.compute.amazonaws.com:8081/projects/list')
      .then(() => {});
    axios
      .get(
        `http://ec2-3-35-26-239.ap-northeast-2.compute.amazonaws.com:8081/projects/participated/${localStorage.getItem(
          'userId',
        )}`,
      )
      .then((res) => {
